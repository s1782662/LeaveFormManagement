...
<body background="img/fabric.png" class="container">
					...
					<ul class="nav nav-justified">
						...
						<li class="dropdown">
						  ...
						  <ul class="dropdown-menu" >
							...
							<li> <a href="proctor.unforms">UN APPROVED FORMS</a></li>								
							</ul>
						</li>
		...
		<div class="panel-heading"><center><h4>APPROVE LEAVE FORMS</h4></center>
		<button class="btn btn-default" onclick=window.location.reload();>REFRESH</button></div>
			<table class="table table-responsive table-bordered" id="approve_leave">
				<thead>
					<th>ID</th><th>NAME</th><th>PLACE</th><th>LEAVING TIME</th><th>RETURNING TIME</th><th>PURPOSE</th><th colspan="2">APPROVE/DECLINE</th>
				</thead>
				<tbody id="tbody">
